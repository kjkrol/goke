...
func TestEditor_Migrate_Empty_IsNoOp(t *testing.T) {
	m := newMgr()
	...
	editor := ent.NewEditor(&m.AddressBook, &m.ArchCatalog, editSpec)

	editor.Migrate(bulk.ChunkSnapshot{}, nil)
	editor.Migrate(bulk.ChunkSnapshot{}, []uid.UID64{})
...
func TestEditor_Migrate_AddComponent(t *testing.T) {
	m := newMgr()
	var mi comp.DefIndex
	mi.Init()
...
func TestEditor_Migrate_AddAlreadyPresentComponent_IsNoOp(t *testing.T) {
	// Editor's AddDefs names a component every source entity already has:
...
func TestEditor_Migrate_RemoveComponent(t *testing.T) {
	m := newMgr()
	var mi comp.DefIndex
	mi.Init()
	posDef, velDef := internDefs(&mi)
...
func TestEditor_Migrate_Unlink_RemovesEntitiesFromBook(t *testing.T) {
...
func TestEditor_Migrate_Unlink_PartialRemoval_SurvivorsConsistent(t *testing.T) {
	...
	applyByChunks(m, editor, []uid.UID64{ids[0], ids[2], ids[4]})
...
func TestEditor_Migrate_AddAndRemove(t *testing.T) {
...
func TestEditor_Migrate_DataPreserved(t *testing.T) {
...
func TestEditor_Migrate_SrcCompaction_RemainingEntitiesConsistent(t *testing.T) {
...
func TestEditor_Migrate_TwoBatches_SameDstArch(t *testing.T) {
	...
	applyByChunks(m, editor, ids1)
	applyByChunks(m, editor, ids2)
...
func TestEditor_Migrate_SlotAlignedFastPath(t *testing.T) {
...
func TestEditor_Migrate_StaleVersion_RevalidatesEntities(t *testing.T) {
...
func TestEditor_Migrate_StaleVersion_AllEntitiesDead_NoOp(t *testing.T) {
...
func TestEditor_Migrate_MultiSrcArch_PerChunkCalls(t *testing.T) {
	...
	// Editor adds mTag to every entity regardless of source archetype.
...
func TestEditor_LazyResolve_NoArchetypeExplosion(t *testing.T) {
	...
	fwd := ent.NewEditor(&m.AddressBook, &m.ArchCatalog, fwdSpec)
	rev := ent.NewEditor(&m.AddressBook, &m.ArchCatalog, revSpec)
...
func TestEditor_SourceArchetypeCreatedAfterConstruction(t *testing.T) {
	// An Editor has no registered set of source archetypes: dst is resolved
	// lazily per source, so an archetype born after the Editor was built
