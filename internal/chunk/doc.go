...
// growth instead of allocating fresh memory, which makes a repeated
// shrink/regrow cycle effectively allocation-free after the first cycle.
// [Pack.Purge] releases that spare (and any other trimmable chunks)
