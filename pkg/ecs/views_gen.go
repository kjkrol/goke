...
func (v *View1[T1]) All() iter.Seq2[Entity, Row1[T1]] {
    return func(yield func(Entity, Row1[T1]) bool) {
       for _, arch := range v.matched {
          ...
          // HOISTING: Używamy prywatnych pól: colTable, columns, len, entities
          
          idx1 := arch.colTable[v.ids[0]]
          col1 := &arch.columns[idx1] 
          ptr1 := col1.data
    ...
    return func(yield func(Entity, Row1[T1]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c1 = &arch.columns[arch.colTable[v.ids[0]]]
             
             lastArch = arch
          }

          // Dostęp do prywatnego pola arch.entityToIndex
...
func (v *View2[T1, T2]) All() iter.Seq2[Entity, Row2[T1, T2]] {
    return func(yield func(Entity, Row2[T1, T2]) bool) {
       for _, arch := range v.matched {
          ...
          idx2 := arch.colTable[v.ids[1]]
          col2 := &arch.columns[idx2] 
          ptr2 := col2.data
    ...
    return func(yield func(Entity, Row2[T1, T2]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c2 = &arch.columns[arch.colTable[v.ids[1]]]
...
func (v *View3[T1, T2, T3]) All() iter.Seq2[Entity, Row3[T1, T2, T3]] {
    return func(yield func(Entity, Row3[T1, T2, T3]) bool) {
       for _, arch := range v.matched {
          ...
          idx3 := arch.colTable[v.ids[2]]
          col3 := &arch.columns[idx3] 
          ptr3 := col3.data
    ...
    return func(yield func(Entity, Row3[T1, T2, T3]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c3 = &arch.columns[arch.colTable[v.ids[2]]]
...
func (v *View4[T1, T2, T3, T4]) All() iter.Seq2[Entity, Row4[T1, T2, T3, T4]] {
    return func(yield func(Entity, Row4[T1, T2, T3, T4]) bool) {
       for _, arch := range v.matched {
          ...
          idx4 := arch.colTable[v.ids[3]]
          col4 := &arch.columns[idx4] 
          ptr4 := col4.data
    ...
    return func(yield func(Entity, Row4[T1, T2, T3, T4]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c4 = &arch.columns[arch.colTable[v.ids[3]]]
...
func (v *View5[T1, T2, T3, T4, T5]) All() iter.Seq2[Entity, Row5[T1, T2, T3, T4, T5]] {
    return func(yield func(Entity, Row5[T1, T2, T3, T4, T5]) bool) {
       for _, arch := range v.matched {
          ...
          idx5 := arch.colTable[v.ids[4]]
          col5 := &arch.columns[idx5] 
          ptr5 := col5.data
    ...
    return func(yield func(Entity, Row5[T1, T2, T3, T4, T5]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c5 = &arch.columns[arch.colTable[v.ids[4]]]
...
func (v *View6[T1, T2, T3, T4, T5, T6]) All() iter.Seq2[Entity, Row6[T1, T2, T3, T4, T5, T6]] {
    return func(yield func(Entity, Row6[T1, T2, T3, T4, T5, T6]) bool) {
       for _, arch := range v.matched {
          ...
          idx6 := arch.colTable[v.ids[5]]
          col6 := &arch.columns[idx6] 
          ptr6 := col6.data
    ...
    return func(yield func(Entity, Row6[T1, T2, T3, T4, T5, T6]) bool) {
       ...
       for _, e := range entities {
          ...
          if arch != lastArch {
             ...
             // Dostęp do prywatnych pól arch.colTable i arch.columns
             c6 = &arch.columns[arch.colTable[v.ids[5]]]
