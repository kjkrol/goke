...
func NewQuery7[T1, T2, T3, T4, T5, T6, T7 any](reg *Registry) *Query7[T1, T2, T3, T4, T5, T6, T7] {
	...
	id7 := ensureComponentRegistered[T7](viewBuilder.reg.componentsRegistry)
	viewBuilder.OnType(id7)
