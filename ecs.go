...
func New(opts ...ECSOption) *ECS {
	...
	ecs := ECS{
		registry: reg.NewRegistry(config),
	}
	ecs.scheduler = exec.NewScheduler(ecs.registry)
	return &ecs
}
